...
public class HlavniProgram {
    ...
    private void nakresliRovnostrannyTrojuhelnik(Turtle zelva, double delkaStrany, int pocetStran, Color barva) {
    ...
    private void nakresliZmrzlinu(Turtle zelva, double poziceX, double poziceY) {
        ...
        nakresliRovnostrannyTrojuhelnik(zelva, 148, 3, Color.orange);
        zelva.setLocation(poziceX, poziceY);
        zelva.turnLeft(200);
    }
    ...
    private void nakresliMasinku(Turtle zelva, double poziceX, double poziceY) {
        ...
        zelva.turnRight(42);
        nakresliRovnostrannyTrojuhelnik(zelva, 150, 3, Color.gray);
    }
